...
class V2Api:
    ...
    def get_schema(
        self,
        schema_id: Annotated[StrictStr, Field(description="The unique identifier for the delivery JSON schema.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param schema_id: The unique identifier for the delivery JSON schema. (required)
        :type schema_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '400': "GetSchema400Response",
            '404': "GetSchema404Response",
            '500': "GetBatch500Response",
        }
        response_data = self.api_client.call_api(
            *_param,
