...
class GetDeliveriesResponse(BaseModel):
    ...
    """ # noqa: E501
    deliveries: List[Delivery] = Field(description="Array of delivery objects")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeliveriesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeliveriesResponse from a dict"""
        if obj is None:
            return None
