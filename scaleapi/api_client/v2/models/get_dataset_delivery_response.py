...
class GetDatasetDeliveryResponse(BaseModel):
    """
    GetDatasetDeliveryResponse
    """ # noqa: E501
    delivery: Optional[ExpandableDatasetDelivery] = None
    ...
    __properties: ClassVar[List[str]] = ["delivery", "tasks", "next_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDatasetDeliveryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDatasetDeliveryResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [DatasetTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None,
