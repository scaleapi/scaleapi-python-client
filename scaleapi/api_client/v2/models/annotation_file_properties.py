...
class AnnotationFileProperties(BaseModel):
    """
    AnnotationFileProperties
    """ # noqa: E501
    value: Optional[AnnotationFilePropertiesValue] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnnotationFileProperties from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnnotationFileProperties from a dict"""
        if obj is None:
            return None
