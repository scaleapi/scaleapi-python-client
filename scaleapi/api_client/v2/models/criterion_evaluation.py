...
class CriterionEvaluation(BaseModel):
    ...
    CriterionEvaluation
    """ # noqa: E501
    criterion_definition_id: Optional[StrictStr] = Field(default=None, description="A unique identifier for a rubric criterion.")
    score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Un-weighted score for the criterion.")
    annotations: Optional[List[Annotation]] = Field(default=None, description="Array of annotations.")
    __properties: ClassVar[List[str]] = ["criterion_definition_id", "score", "annotations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CriterionEvaluation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CriterionEvaluation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "criterion_definition_id": obj.get("criterion_definition_id"),
            "score": obj.get("score"),
