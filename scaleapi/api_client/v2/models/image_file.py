...
class ImageFile(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the image file.")
    file_size_in_bytes: Optional[StrictInt] = Field(default=None, description="The size of the file in bytes.")
    __properties: ClassVar[List[str]] = ["mime_type", "scale_url", "url", "name", "file_size_in_bytes"]
