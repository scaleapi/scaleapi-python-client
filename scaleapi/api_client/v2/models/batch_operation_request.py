...
class BatchOperationRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["batch_id", "batch_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BatchOperationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BatchOperationRequest from a dict"""
        if obj is None:
            return None
