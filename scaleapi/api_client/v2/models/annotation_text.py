...
class AnnotationText(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnnotationText from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnnotationText from a dict"""
        if obj is None:
            return None
...
AnnotationText.model_rebuild(raise_errors=False)
