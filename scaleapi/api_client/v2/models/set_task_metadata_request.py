...
class SetTaskMetadataRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["task_id", "metadata", "merge"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetTaskMetadataRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetTaskMetadataRequest from a dict"""
        if obj is None:
            return None
