...
class ChunkText(BaseModel):
    ...
    ChunkText
    """ # noqa: E501
    type: StrictStr = Field(description="The type of chunked data.")
    annotations: List[Annotation] = Field(description="Array of annotations.")
    text: StrictStr = Field(description="A plain text field.")
    __properties: ClassVar[List[str]] = ["type", "annotations", "text"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChunkText from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChunkText from a dict"""
        if obj is None:
            return None
