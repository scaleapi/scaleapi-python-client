...
class GetDeliveredTasksResponse(BaseModel):
    """
    GetDeliveredTasksResponse
    """ # noqa: E501
    delivery: Optional[ExpandableDelivery] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDeliveredTasksResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDeliveredTasksResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "delivery": ExpandableDelivery.from_dict(obj["delivery"]) if obj.get("delivery") is not None else None,
