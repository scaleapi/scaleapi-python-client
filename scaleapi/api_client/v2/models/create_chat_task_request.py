...
class CreateChatTaskRequest(BaseModel):
    ...
    template_variables: Optional[Dict[str, Any]] = Field(default=None, description="Template variables for task creation.")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Custom metadata for the entity.")
    callback_url: Optional[StrictStr] = Field(default=None, description="Callback URL or email for the entity upon completion.")
    __properties: ClassVar[List[str]] = ["project_id", "project_name", "batch_id", "batch_name", "template_variables", "metadata", "callback_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateChatTaskRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateChatTaskRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "template_variables": obj.get("template_variables"),
