...
class GetBatchesResponse(BaseModel):
    ...
    GetBatchesResponse
    """ # noqa: E501
    batches: List[Batch] = Field(description="Array of batch objects")
    ...
    __properties: ClassVar[List[str]] = ["batches", "next_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetBatchesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetBatchesResponse from a dict"""
        if obj is None:
            return None
