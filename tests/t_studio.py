...
new_teammates = client.invite_teammates([test_email_invite], scaleapi.TeammateRole.Member)
...
updated_teammates = client.update_teammates_role([test_email_invite], scaleapi.TeammateRole.Manager)
...
removed_assignment = client.remove_studio_assignments([test_email_invite], [test_project])
...
added_project_group = client.create_project_group(test_project, [test_email_invite], project_group_name)
...
updated_project_group = client.update_project_group(test_project, project_group_name, [], [test_email_invite])
print('Test removing project group')
print(updated_project_group.as_dict())

re_updated_project_group = client.update_project_group(test_project, project_group_name, [test_email_invite], [])
...
studio_batch_priority = client.set_studio_batches_priorities(list(map(lambda sb: sb.name, studio_batches)))
